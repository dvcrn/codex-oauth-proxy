...
const DEFAULT_PACKAGE_NAME = "codex-oauth-proxy";
const DEFAULT_UPDATE_COMMAND = "npm install -g codex-oauth-proxy";
...
function isDisabled() {
  return (
    process.env.CODEX_PROXY_NO_UPDATE_NOTICE === "1" ||
    process.env.CODEX_PROXY_NO_UPDATE_NOTICE === "true" ||
